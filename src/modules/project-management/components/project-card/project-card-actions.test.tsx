...
vi.mock('@/modules/project-management/components/project-form/project-form-dialog', () => ({
  ProjectFormDialog: () => null,
}))

vi.mock('@/modules/project-management/hooks/use-archive-project', () => ({
  useArchiveProject: () => ({ isPending: false, mutate: vi.fn() }),
}))

vi.mock('@/modules/project-management/hooks/use-copy-project', () => ({
