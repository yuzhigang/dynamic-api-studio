...
import { SchemaRowActions } from '@/modules/project-management/components/response-schema/schema-row-actions'
import { SchemaTypeSelect } from '@/modules/project-management/components/response-schema/schema-type-select'
